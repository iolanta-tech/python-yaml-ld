...
from yaml_ld.document_parsers.yaml_parser import _ensure_not_scalar
...
class MarkdownDocumentParser(BaseDocumentParser):
    ...
    def __call__(   # noqa: WPS238, WPS231, WPS225, C901
        ...
        try:
            metadata, _content = frontmatter.parse(markdown_content)
        except Exception as parse_error:
            raise LoadingDocumentFailed(path=source) from parse_error

        return _ensure_not_scalar(metadata)
